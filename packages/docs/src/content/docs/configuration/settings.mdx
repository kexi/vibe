...
:::note[Schema URL Availability]
Schema URLs are only available for **released versions**. If you're using a development build, the schema URL may not be accessible until the version is officially released.
:::
