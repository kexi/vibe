...
| `vibe copy`                          | Copy files/dirs from main worktree using CoW     |
...
# Copy files/dirs from main worktree (in a secondary worktree)
vibe copy
...
- [copy](/commands/copy/) - Copy files from main worktree
