...
Note: `--claude-code-worktree-hook` is used internally by Claude Code's WorktreeCreate hook. See [Claude Code Integration](/configuration/hooks/#claude-code-integration) for setup details.
