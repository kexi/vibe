...
<Tabs>
  ...
  <TabItem label="Windows">
    :::caution
    ネイティブな Windows バイナリは再構築中で現在は配布されておらず、Windows 向け npm パッケージもまだありません。[WSL2](https://learn.microsoft.com/ja-jp/windows/wsl/) 上で Linux の手順を使うか、ソースからビルドしてください。詳しくは[インストール → Windows](/ja/installation/#windows)を参照してください。
    :::
...
<Tabs>
  <TabItem label="Zsh">
    ...
    # グローバルインストール用（Homebrew, npm -g, bun -g）
