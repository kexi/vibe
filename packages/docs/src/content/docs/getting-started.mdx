...
<Tabs>
  ...
  <TabItem label="Windows">
    :::caution
    Native Windows binaries are being reworked and are not currently published, and there is no Windows npm package yet. Run vibe under [WSL2](https://learn.microsoft.com/windows/wsl/) with the Linux instructions, or build from source. See [Installation → Windows](/installation/#windows) for details.
    :::
